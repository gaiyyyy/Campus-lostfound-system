...
export const getLostItemList = (params = {}) => {
  return axios.get('/api/lost_item', { params })
}

// 获取详情
export const getLostItemDetail = id => {
  return axios.get(`/api/lost_item/${id}`)
}

// 发布
export const createLostItem = data => {
  return axios.post('/api/lost_item', data)
}

// 编辑
export const updateLostItem = (id, data) => {
  return axios.put(`/api/lost_item/${id}`, data)
}

// 删除
export const deleteLostItem = id => {
  return axios.delete(`/api/lost_item/${id}`)
}

// 更新状态
export const updateLostItemStatus = (id, status) => {
  return axios.put(`/api/lost_item/${id}/status`, null, {
    params: { status }
  })
}
...
export const getMyLostItems = () => {
  return axios.get('/api/lost_item')  // 不传 user_id
